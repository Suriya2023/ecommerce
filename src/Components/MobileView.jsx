  ...
  return (
    <div >
      ...
      <div id='mbbottom' className="nav-bar">
        <Link to="/ecommerce/" className={`nav-item text-${props.mode}`}>
        ...
        <Link to="/ecommerce/Search" id='this' className="nav-item">
        ...
        <div id='call' className="center-button" ><Link to="/ecommerce/">+</Link></div>
        ...
        <Link to="/ecommerce/UserLogin" className="nav-item active">
