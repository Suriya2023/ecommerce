...
function SmartShop2(props) {
    ...
    const a = "dyson Airwrap Hair Styler with Intelligent Heat Control (Enhanced Coanda Airflow, Prussian Blue )"
    let B = " Deals You Can't Miss (Extra Offers Inside) "
    let b = "dyson Cool Gen1 TP10 Air Multiplie Technology Air Purifier (350 Degree Oscillation, 45484901, White)"
    let c = "dyson Airwrap 8-in-1 Hair Styler with Coanda Airflow (Cold Shot, Blue & Cooling ,Airflow  Blush)"
    let d = "Xiaomi 4 Triple Layer Filtration Air Purifier (Laser Particle Sensor, ACM16SC, ACM17SC, ACM18SC, White) "
    let e = "PHILIPS AC0950/60 HEPA Filtration Technology Smart Air Purifier (Connects via Wi-Fi, Arctic White)"
    return (
        <div className={`bg-${props.mode}`}>



            <h1 className='text-center textcenter text-3xl font-semibold   cursor-pointer hover:text-red-500 hover:underline'>
                <span style={{ fontWeight: '600', textAlign: 'center', cursor: 'pointer', hover: 'underline', fontFamily: 'Times New Roman, Times, serif', fontSize: '2rem' }} id='LastWord' className={`color-${props.mode}`}> <Paragraph text={B} wordLimit={8} /> <span id='LastWordChange'></span>  </span>
            </h1>
            ...
            <div id='gdcd' className='grid  p-10 max-w-screen-xl mx-auto gap-3'>
                <div id='card1' className="w-full localll  max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="px-5 pb-5">
                            <a href="#">
                                <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white"><Paragraph text={a} wordLimit={11} /> </h5>
                            </a>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => handleAddToCart('4', a, '50,000', 'product-image-url')}>
                ...
                <div id='card1' className="w-full localll max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="px-5 pb-5">
                            <a href="#">
                                <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white"><Paragraph text={c} wordLimit={12} /> </h5>
                            </a>
                            <div className="flex items-center mt-2.5 mb-5">
                                <div className="flex items-center space-x-1 rtl:space-x-reverse">
                                    <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-xl font-bold text-gray-900 dark:text-white">₹45,000</span> &nbsp;
                                <button onClick={() => handleAddToCart('1', c, '45,000', 'product-image-url')}>
                        ...
                        <div className="px-5 pb-5">
                            <a href="#">
                                <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                                    <Paragraph text={b} wordLimit={11} /> </h5>
                            </a>
                            <div className="flex items-center mt-2.5 mb-5">
                                <div className="flex items-center space-x-1 rtl:space-x-reverse">
                                    <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                            ...
                            <div className="flex items-center justify-between">
                                <span className="text-xl font-bold text-gray-900 dark:text-white">₹32,900</span> &nbsp;
                                <button onClick={() => handleAddToCart('3', b, '32,900', 'product-image-url')}>
                ...
                <div id='card1' className="w-full localll max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="px-5 pb-5">
                            <a href="#">
                                <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white"> <Paragraph text={d} wordLimit={11} /> </h5>
                            </a>
                            <div className="flex items-center mt-2.5 mb-5">
                                <div className="flex items-center space-x-1 rtl:space-x-reverse">
                                    <svg className="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => handleAddToCart('1', d, '13,999', 'product-image-url')}>
                                    <a id='addtocart1' href="#" className='check-pricee'>Add to cart</a>
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="px-5 pb-5">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => handleAddToCart('2', d, '9,999', 'product-image-url')}>
